...
исходными данными и присланными, конфликтующие записи не вставляются и с ответе
в поле `"problems"` вернётся массив пар учётных записей -- имеющаяся и новая,
для которых данные не стыкуются.
Отсутсвие информации не расценивается как несостыковка.
